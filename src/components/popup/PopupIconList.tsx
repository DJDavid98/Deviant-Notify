...
export const PopupIconList: VFC<Partial<UnreadCounts>> = ({ messages = 0, feedback = 0, watch = 0 }) => (
  <Fragment>
    <PopupIconItem iconName="chat" count={messages} clickAction={ExtensionAction.OPEN_MESSAGES_PAGE} />
    <PopupIconItem iconName="bell" count={feedback} clickAction={ExtensionAction.OPEN_NOTIFS_PAGE} />
